                    ...
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" class="table table-striped">
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Edit">
                                <ItemTemplate>                                    
                                    <asp:LinkButton ID="LinkButton1" runat="server" class="btn btn-warning btn-sm" 
                                        CommandArgument='<%# Eval("Pr_Id") %>' onclick="LinkButton1_Click">Edit</asp:LinkButton>                                    
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Delete">
                                <ItemTemplate>
                                    <asp:LinkButton ID="LinkButton2" runat="server" class="btn btn-danger btn-sm" onclientclick="return confirm('Are you sure you want to delete this project?')"
                                        CommandArgument='<%# Eval("Pr_Id") %>' onclick="LinkButton2_Click">Delete</asp:LinkButton>
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
                    </asp:GridView>
